...
HD_PWD='C:/Users/chewj/Desktop/final_ver.xpr/output_keyboard_screen/output_keyboard_screen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log guesser_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source guesser_main.tcl
