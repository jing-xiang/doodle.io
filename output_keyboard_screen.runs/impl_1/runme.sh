...
HD_PWD='C:/Users/chewj/Desktop/final_ver.xpr/output_keyboard_screen/output_keyboard_screen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log guesser_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source guesser_main.tcl -notrace
