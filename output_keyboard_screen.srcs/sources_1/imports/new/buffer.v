...
module fifo
	#(
	   parameter	DATA_SIZE 	   = 40,	       // number of bits in a data word
	...
	always @* begin
		...
		next_write_addr = (current_write_addr + 1 + ADDR_SPACE_EXP) % ADDR_SPACE_EXP;
		next_read_addr  = (current_read_addr + 1 + ADDR_SPACE_EXP) % ADDR_SPACE_EXP;
		...
		endcase
//		if(current_read_addr_buff == current_write_addr_buff) begin
//		  empty_buff = 1'b1;
//		end
//		else begin
//		  empty_buff = 1'b0;
