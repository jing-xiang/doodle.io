...
module uart_receiver
    #(
        parameter   DBITS = 40,          // number of data bits in a data word
    ...
    reg [5:0] nbits_reg, nbits_next;    // number of bits received in data state
    reg [39:0] data_reg, data_next;      // reassembled data word
